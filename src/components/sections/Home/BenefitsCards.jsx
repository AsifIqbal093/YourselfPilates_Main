		...
		<section className="py-20 bg-gradient-primary">
			<div className="flex flex-col items-center text-center space-y-4">
				<h1 className="text-5xl font-light font-accent mb-9 text-center">
					...
					<span className="text-[#0f3660] font-light">YourSelf </span>
					<span className="text-[#88a9c3]">?</span>
				</h1>

				<Link
					href="/sobre"
					className="inline-block text-lg text-[#88a9c3] font-normal underline decoration-2 underline-offset-4 transition-all duration-200 group mb-16"
				>
			...
			<div className="container mx-auto px-4 md:px-6 lg:px-8">
				<motion.div
					...
					initial="hidden"
					animate="visible"
					className="grid grid-cols-1 md:grid-cols-2 gap-x-4 gap-y-10 justify-items-center mx-auto max-w-[1200px]"
				>
